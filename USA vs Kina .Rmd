...
## SP500 aksje indeks 
sp500 <-  read_csv("data/^GSPC.csv", col_types = cols(Close = col_number(), 
...
```
Her ser vi endring i verdi på logarismisk skala. Vi ser at bitcoin har hatt en veldig stor økning i 2017, uten at de andre faktorerne i finansmarkedet har har nevneverdige bevegelser. Vi skal dermed se nærmere på dataen og ta en korrelasjonstest. 
...
```
Ut fra korrelasjons matrixen kan det se ut som Bitcoin er avhengig av utviklingen i det amerikanske makredet. Med en korrelasjon med SP500 på 0.75 og USA 3 month treasury på 0.85. Det problematiske er at bitcoin datasette går bare tilbake til 2012. Det gjør at tidshorisonten blir begrenset når en business cickle gjerne er i x år. (sett inn kilde ) 

Vi har derfor laget et til datasett med de dataene som er over lengre tid for å kunne analysere korrelasjoner helt tilbake til 2001, men da uten bitcoin. 
