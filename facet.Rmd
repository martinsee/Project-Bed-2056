...
Vi ønsker å undersøke om prisutviklingen på bitcoin er relatert til kursene på verdens aksjemarkeder. Vi har hentet daglig data for bitcoin i USD (BTC/USD) og s&p500 så langt bak i tid som mulig. Siden BTC kan kjøpes og selges hele uka, også i helgene, mens børsnoterte aksjer kun handles mandag-fredag.Stolpediagrammet nedenfor viser gjennomsnitts- og median-pris for bitcoin fordelt på de ulike ukedagene. I tillegg har vi foretatt en t-test for å sjekke om forskjellene i gjennomsnit for ukedager og helger er statistisk signifikante. 

Vi har valgt den amerikanske indeksen S&P 500 og den kinesiske indeksen Shanghai Composite. Videre forklaring hva indeksene er.
...
Grafen viser det ikke, men ved et kall på summary() av dataen ser vi at minimumsprisen på bitcoin er 0. Det viser det seg at datasettet har prisen 0 fire sammenhengende dager i august 2016. Vi mener at verdien 0 representerer at dataen er manglende. Datasettet filtreres slik at alle verdier er høyere enn 0. 
...
p-verdien fra testen er 0.97, noe som er svært høyt. Forskjellene er dermed ikke signifikante, uansett hvilket signifikansnivå vi velger.
Ettersom forskjellene ikke er signifikante har vi valgt å fjerne observasjoner lørdager og søndager slik at vi kan "matche" datasettet til aksjeindeksene. En alternativ løsning kunne vært å omgjøre prisene og aksjekursene til ukentlig data.
...
ggplot(shanghai, aes(x=Date, y=SH)) +
...
Summary() av datasettene for aksjeindeksene viser ingen manglende verdier eller nullverdier. Dataen inner_joines på dato som er felles for alle datasett. Inner_join matcher bare dato hvor alle datasettene har verdier. I tillegg omgjør vi datasettet fra "wide" til "long". Hver dato har nå to observasjoner av BTC matchet med hver av indeksene i kolonnen "index". Dataen strekker seg fra februar 2012 til november 2018. 
